...
export interface SimPose { recumbency:Recumbency; rotationY:number; oblique:number; chinUp:number; shoulderRoll:number; armRaise:number; elbowFlex:number; armSide:ArmSide; kneeFlex:number; hipInternal:number; breath:Breath; }

...
export const SHARED_ORGANS: OrganShape[] = [
  ...
  // Shift the cardiac silhouette towards the patient's left (detector right)
  // and make it slightly narrower/taller so it reads as a PA heart rather than
  // a centred circular density.
  { id: "heart", xCm: 3.2, yCm: 43.1, widthCm: 4.9, heightCm: 6.7, depthCm: 5.6, density: "soft" },
